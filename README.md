...
This repository contains the Ray deployment code used to deploy models on Ray Serve and AKS. To deploy these services, use the configuration files in the [DLIS_Intern](https://dev.azure.com/msasg/Bing_and_IPG/_git/DLIS_Intern) repo.
